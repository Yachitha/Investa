...
<head>
    ...
    <title>Southern Property Developers - Micro Credit System for rural people</title>
    <!-- Bootstrap Core CSS -->
    <link href="pixeladmin-lite/html/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Menu CSS -->
    <link href="pixeladmin-lite/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css" rel="stylesheet">
    <!-- animation CSS -->
...
"></i></a>
            <div class="top-left-part"><a class="logo" href="underConstruction"><b><img src="pixeladmin-lite/si2.png"
                                                                                        alt="home"/></b><span
                        class="hidden-xs"><b class="hidden-xs">Investa</b></span></a></div>
            ...
            <ul class="nav navbar-top-links navbar-right pull-right">
                <li>
                    <a class="profile-pic" href="#"> <img src="pixeladmin-lite/plugins/images/users/varun.jpg"
                                                          alt="user-img" width="36" class="img-circle"><b
                            class="hidden-xs">{{ \Illuminate\Support\Facades\Auth::user ()->name }}</b> </a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="sidebar-nav navbar-collapse slimscrollsidebar">
            <ul class="nav" id="side-menu">
                <li style="padding: 10px 0 0;">
                    <a href="{{ url('/createCustomer') }}" class="waves-effect"><i class="fa fa-clock-o fa-fw"
                                                                                   aria-hidden="true"></i><span
                            class="hide-menu">Create Customer</span></a>
                </li>
                <li>
                    <a href="{{ url('/createLoan') }}" class="waves-effect"><i class="fa fa-user fa-fw"
                                                                               aria-hidden="true"></i><span
                            class="hide-menu">Create Loan</span></a>
                </li>
                <li>
                    <a href="{{ url('/bankBalance') }}" class="waves-effect"><i class="fa fa-table fa-fw"
                                                                                aria-hidden="true"></i><span
                            class="hide-menu">Add Bank Balance</span></a>
                </li>
                <li>
                    <a href="{{ url('/cashBalance') }}" class="waves-effect"><i class="fa fa-font fa-fw"
                                                                                aria-hidden="true"></i><span
                            class="hide-menu">Add Cash Book Balance</span></a>
                </li>
                {{--<li>--}}
    ...
    <!-- jQuery -->
    <script src="pixeladmin-lite/plugins/bower_components/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap Core JavaScript -->
    <script src="pixeladmin-lite/html/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- Menu Plugin JavaScript -->
    <script src="pixeladmin-lite/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js"></script>
